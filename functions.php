...
function skeletor_scripts() {
	...
	wp_enqueue_script( 'modernizr', $template_dir . '/js/libs/modernizr-2.6.2-min.js', array( ), '2.6.2', false );
	
	if ( defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG ) {
		wp_enqueue_script( 'bootstrap', $template_dir . '/js/libs/bootstrap.min.js', array( 'jquery' ), '3.0.0', true );
		wp_enqueue_script( 'skeletor', $template_dir . '/js/skeletor.js', array( 'jquery', 'bootstrap', 'modrnizr' ), '3.0.0', true );
	} else {
		wp_enqueue_script( 'bootstrap', $template_dir . '/js/libs/bootstrap.min.js', array( 'jquery' ), false, true );
		wp_enqueue_script( 'skeletor', $template_dir . '/js/skeletor.min.js', array( 'jquery', 'bootstrap' ), false, true );
	}
}
